...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="#"><!span class="glyphicon glyphicon-refresh"> UpdateLogs </a></li>
...
$cn=mysqli_connect("localhost","root","","IOT");
    $contacts = mysqli_query($cn,"
        SELECT * FROM UPDATELOGS ORDER BY EMAIL") or die( mysqli_error($cn) );
    if( mysqli_num_rows($contacts) > 0 )?>
</head>

    <table id="UpdateLogs-list" class="w3-table-all w3-centered w3-hoverable w3-card-4"> 
            <tr class="w3-black">
                <th>Email</th>
                <th>Name</th>
                <th>Phone</th>
