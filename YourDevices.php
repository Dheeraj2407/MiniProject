    ...
    for($i=1;$i<9;$i++){
      if($fields[$i]!=""){
        if($out[$i]==1){
          ...
          echo '<iframe width="450" height="260" style="border: 1px solid #cccccc;" src="https://thingspeak.com/channels/'.$c["channelid"].'/charts/'.$i.'?bgcolor=%23ffffff&color=%23d62020&dynamic=true&results=60&type=line&update=15"></iframe>';
          echo $i;
        }
      }
    }
