...
<body>
  ...
  <div id="phrase" class="glow"><span title="Click me!" style="cursor:pointer" onclick="openNav()">Connector Votre Maison &reg;</span></div>
  ...
  <div id="myNav" class="overlay">
    ...
    <div class="overlay-content">
      ...
      <a href="#" onclick="closeNav();document.getElementById('aboutModal').style.display='block'">About</a>
      <a href="#" onclick="alert('Contact us at\ndheerajvijayakumar19@gmail.com\nimmanuelebe30@gmail.com')">Contact</a>
    </div>
  </div>
  <div id="aboutModal" class="modal1">

    <form class="modal2-content animate" action="home2.php" method="POST">
      <div class="imgcontainer1">
        <span onclick="document.getElementById('aboutModal').style.display='none'" class="closel1" title="closel1 modal1">&times;</span>
        <h3>About us</h3>
      </div>
      ...
      <div class="container1">
        ...
        Who are we?
        Myself Immanuel and my partner Dheeraj we are currently studying in our final year Engineering, ISE Department.

        What is our main aim?
        Our main aim is to build up a smart home with the help of smart devices, thereby reducing manual work and increasing the work done technologically and smartly.

        What is our system about?
        Our system provides a customer with a login where he can select a number of devices that he wants and accordingly he can use them to manage his house. In the back end an admin will sit up and he can view the activities which are done by the customers.
        HomeAutomat gives you a quick glance on the smart home automation offerings.
        Then roll your mouse over the communication icon/symbol to see what a smart home automation can deliver to your safe, secure, savings and convenience.
        Answer the front door from the backyard or accept a delivery while still at the office. Your private network hub for communicating anywhere, lets you see, hear, and respond to visitors, whether you’re on the couch, in the car, or out of the country.


        How does it help people?
        Take for yourself to be a businessman, I meant a busy one and you are on your own, while leaving the house you forget to turn the controls off, worried?
        You don’t have to be cause our system helps you monitor and control the house with a single touch.

        How long will the activity be recorded of a device?
        The device can be used to monitor a particular area for a period of 5 days and we will show you a digitized method where in graph will be displayed.
      ...
      <div class="container1" style="background-color:#f1f1f1">
        <button type="button" onclick="document.getElementById('aboutModal').style.display='none'" class="cancelbtn1">Close</button>
      </div>
    </form>
  </div>
